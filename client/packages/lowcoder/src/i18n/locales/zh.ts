...
export const zh = {
    ...
    gantee: {
        ...
        dateFormat: '日期格式',
        viewMode: '显示模式',
        viewModeTooltip: '显示模式支持: Hour, QuarterDay, HalfDay, Day, Week, Month, Year',
        hiddenListCell: '隐藏列表',
        cellWidth: '单元格宽度',
        ColumnsData: '列数据',
        CustomColumn: '自定义列',
        FirstColumnTitle: '首列标题',
        FirstColumnWidth: '首列宽度',
        tasks: '任务数据',
        project: '项目',
        from: '开始时间',
        to: '结束时间',
        ...
        second: '秒',
        millisecond: '毫秒',
        allowDateChange: '允许拖动修改日期',
        handleDateChange: '处理日期修改',
        allowProgressChange: '允许拖动修改进度',
        handleProgressChange: '处理进度修改',
        allowItemDelete: '允许删除项目',
        handleItemDelete: '处理项目删除',
        deleteConfirmation: '确定要删除项目： {name} 吗?',
        autoWrap: '自动换行',
        currentTaskObject: '当前的任务',
        JSONStyle: 'JSON样式',
        tooltipDateFormat: '提示日期格式',
        duration: '持续',
        tooltipDateUnits: '提示日期单位',
        progress: '进度',
        exampleProject: '项目{i}',
        exampleIdea: '创意',
        exampleRearch: '需求分析',
