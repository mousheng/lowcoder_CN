...
export const en = {
  ...
  uiComp: {
    ...
    FloatButtonCompDesc: "Float Button component",
    FloatButtonCompKeywords: "",
    linkCompName: "Link",
  ...
  docUrls: {
    docHome: "https://mousheng.github.io/lowcoder_CN/#/",
        ...
        eventHandlerSlowdown:
            "https://mousheng.github.io/lowcoder_CN/#/event-handler?id=%e9%98%b2%e6%8a%96%e8%8a%82%e6%b5%81",
  ...
  comment: {
    ...
    title: "Title",
    titledDefaultValue: "%d Comment(s) In Total",
  ...
  gantee: {
    ...
    viewMode: 'View Mode',
    viewModeTooltip: 'View Mode: Hour, QuarterDay, HalfDay, Day, Week, Month, Year',
    hiddenListCell: 'Hidden List Cell',
    cellWidth: 'Cell Width',
    ColumnsData: 'Columns Data',
    CustomColumn: 'Custom Column',
    FirstColumnTitle: 'Main Column Title',
    FirstColumnWidth: 'First Column width',
    tasks: 'Tasks Data',
    project: 'Project',
    from: 'From',
    to: 'To',
    ...
    allowDateChange: 'Allow Date Change',
    handleDateChange: 'Handle Date Change',
    allowProgressChange: 'Allow Progress Change',
    handleProgressChange: 'Handle Progress Change',
    allowItemDelete: 'Allow Item Delete',
    handleItemDelete: 'Handle Item Change',
    deleteConfirmation: 'Are you sure about delete: {name} ?',
    autoWrap: 'Auto Wrap',
    currentTaskObject: 'Current Task Object',
    JSONStyle: 'JSON Style',
    tooltipDateFormat: 'Tooltip Date Format',
    duration: 'Duration',
    tooltipDateUnits: 'Tooltip Date Units',
    progress: 'Progress',
    exampleProject: 'Project1',
    exampleIdea: 'idea',
    exampleRearch: 'Rearch',
    exampleDiscus: 'Discussion with team',
